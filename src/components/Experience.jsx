                ...
                <div>
                   ...
                   <div className='divide-y-2 divide-dashed'>
                        <div className='py-6'>
                            ...
                            <p><a href={'https://www.bookreport.io/'} target="_blank" rel="noreferrer" className='font-medium text-sky-900'>Bookreport</a> | <a className='text-neutral-400'>May 2022 - Present</a></p>
                        ...
                        <div className='py-6'>
                            ...
                            <p><a href={'https://www.masters.edu/'} target="_blank" rel="noreferrer" className='font-medium text-sky-900'>The Master&apos;s University</a> | <a className='text-neutral-400'>Oct 2020 - May 2021</a></p>
                        ...
                        <div className='py-6'>
                            ...
                            <p><a href={'https://www.masters.edu/'} target="_blank" rel="noreferrer" className='font-medium text-sky-900'>The Master&apos;s University</a> | <a className='text-neutral-400'>June 2021 - July 2021</a></p>
                        ...
                        <div className='py-6'>
                            ...
                            <p><a href={'https://www.trophycoffee.co/'} target="_blank"rel="noreferrer" className='font-medium text-sky-900'>Trophy Coffee</a> | <a className='text-neutral-400'>May 2022 - November 2022</a></p>
                        </div>
                        ...
                        <div className='py-6'>
                            ...
                            <p><a href={'https://www.masters.edu/life-at-tmu/housing-and-dining/waldock/'} target="_blank" rel="noreferrer" className='font-medium text-sky-900'>Waldock Hall</a> | <a className='text-neutral-400'>May 2021 - Present</a></p>
                        </div>
                   </div>
                </div>
            </div>
