        ...
        <div className='w-full text-left px-8 ob-4'>
            <div className='max-w-screen-xl w-full py-24 pb-48 md:my-36 flex items-center'>
                <div>
                    ...
                    <a title="GitHub" href={'https://github.com/lhris'} target="_blank" rel="noreferrer" className='flex w-[23%] border border-neutral-200 rounded-lg p-4 items-center text-neutral-800 hover:bg-neutral-100 transition-all justify-between cursor-pointer'>
                        <div className='flex gap-3 font-bold'>
                            <FiGithub size={20}/>
                    ...
                    <a title="Email" href={'mailto:leecc@masters.edu'} className='flex w-[23%] border border-neutral-200 rounded-lg p-4 items-center text-neutral-800 hover:bg-neutral-100 transition-all justify-between cursor-pointer'>
                        <div className='flex gap-3 font-bold'>
                            <FiMail size={20}/>
