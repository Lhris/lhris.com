        ...
        <div className='w-full text-left px-8 ob-4'>
            <div className='max-w-screen-xl w-full py-24 pb-48 md:my-36 flex items-center'>
                <div>
                    ...
                    <a className='flex w-[23%] border border-neutral-200 rounded-lg p-4 items-center text-neutral-800 hover:bg-neutral-100 transition-all justify-between cursor-pointer'>
